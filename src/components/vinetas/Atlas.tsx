...
const SLIDES: Slide[] = [
  {
    ...
    kick: "El producto",
    title: { pre: "Una torre de control ", accent: "funcional", post: ", por iniciativa propia" },
    ...
    more: "Más que una maqueta de portfolio: un prototipo funcional, validado en simulador. Modo noche, datos densos, cuatro módulos operativos.",
    ...
    chips: [["Prototipo", "estado"], ["~1.500", "máquinas simuladas"], ["4", "módulos"]],
  ...
  },
  {
    ...
    more: "Antes, la carga se distribuía a criterio del coordinador y el desequilibrio no se veía hasta que daba problemas. Con Atlas queda mucho más pareja: el coeficiente de variación cae de 0.55 a 0.39.",
    chips: [["−28%", "desequilibrio"], ["−38%", "km medios"], ["−47%", "carga pico"]],
  ...
  },
  {
    ...
    lead: "Un solver GAP decide capa a capa por especialidad, cuentas fijas y cupo, y respeta las restricciones del mundo real: por ejemplo, una máquina que solo puede atender el único técnico certificado de la zona.",
    more: "Tres fases de búsqueda local (move+swap) reducen el coeficiente de variación de 0.55 a 0.39, con un 0 % de máquinas sin cubrir.",
    chips: [["4 capas", "de decisión"], ["0.55→0.39", "equilibrio"], ["0%", "sin cubrir"]],
  ...
  },
  {
    ...
    kick: "En vivo",
    title: { pre: "Un clic y el ", accent: "motor real", post: " organiza la jornada" },
    lead: "«Ejecutar demo» corre el motor de verdad: lee un Excel de muestra con el formato del ERP, asigna por especialidad (la orden OR-1042 va al único técnico certificado de la zona) y equilibra la carga de 0.55 a 0.39.",
    more: "Sin programar una línea: definí la lógica —un solver determinista, no una IA en tiempo real— y la materialicé usando la IA como herramienta de construcción. Un prototipo funcional, de la idea a la demo.",
    chips: [["1 clic", "sin archivos"], ["14/15", "auto-asignadas"], ["0.55→0.39", "equilibrio"]],
