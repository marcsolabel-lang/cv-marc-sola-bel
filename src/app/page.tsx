...
/* ─── Gesto base (Reveal) — rescatado, gesto base de todas las viñetas ─── */
...
/* ─── Técnica de peso variable — rescatada para el statement del Hero ─── */
...
/* ─── Esqueleto ─────────────────────────────────────────────────────────── */
/* Tokens y fuentes listos. Viñetas se construyen después de aprobar el Hero */
  ...
  return (
    <>
      ...
      <main>
        ...
        {/* ── 1. HERO · oscuro ────────────────────────────────────────────── */}
        <section className="bg-dark min-h-[100dvh] flex items-center px-6 md:px-12">
        ...
        {/*
          ── 2. CITA · oscuro ──────── pendiente diseño Hero
          ── 3. SOBRE MÍ · claro ───── pendiente diseño Hero
          ── 4. FORMACIÓN · claro ──── pendiente diseño Hero
          ── 5. EXPERIENCIA · claro ── pendiente diseño Hero
          ── 6. LIDERAZGO · claro ──── pendiente diseño Hero
          ── 7. CROWN PLANNER · oscuro pendiente diseño Hero
        */}
